...
def train_agent(n_games=1, games_per_checkpoint=1, model_save_dir='model2/', base_filename = 'Mancala_agent', plot_save_folder='moving_averages_alpha_decay_2', alpha_decay = 0.999, min_alpha=0.01):
